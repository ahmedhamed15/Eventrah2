$(function() {
    ...
    $('.eventrah-body, .services, .registeration-links, .login-page, .register-page, .management-links, .select-design, .format-page').css('minHeight', ($(window).height() - ($('.navbar').innerHeight() + $('footer').innerHeight() - 7)));
