$(function() {
    ...
    $('.eventrah-body, .services, .registeration-links, .login-page, .register-page, .management-links, .select-design, .format-page, .event-details, .place-details, .login-cards, .choose-category, .price-details, .login-cards-links, .conferences, .events, .services-offering, .notes, .help, .pay-details, .category-price').css('minHeight', ($(window).height() - ($('.navbar').innerHeight() + $('footer').innerHeight() - 7)));
